...
class audio_fL{
  constructor(){
    ...
    this.radio_name=[];
    this.radio_name[0]="Radio Rotana";
    this.radio_name[1]="Radio UFM";
    ...
    this.radio_sours=[];
    this.radio_sours[0]="http://curiosity.shoutca.st:6035/;";
    this.radio_sours[1]="http://stream.ufmradio.com:8000/stream";
